...
class LinkedList {
public:
	LinkedList() : front(nullptr), back(nullptr), count(0) {} // Creates an empty list by setting front and back of the list to nulllptr
...
shared_ptr<Node<Type>> LinkedList<Type>::getMiddle(shared_ptr<Node<Type>> head) {
    ...
    // have 1 slow and 1 fast pointer to find the middle
